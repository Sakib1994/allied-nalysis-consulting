<template>
    ...
    <footer class="footer bg-slate-700 text-base-content place-items-center px-10 py-4">
        <aside class="grid-flow-col items-center text-neutral-100">
            <p>
                Copyright © 2024 Allied Analysis Consulting, All rights reserved.
            </p>
        </aside>
    </footer>
</template>