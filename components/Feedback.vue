<template>
  <section id="testimonials" aria-label="What our customers are saying" class="bg-slate-700 py-18 sm:py-24">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="mx-auto max-w-2xl md:text-center">
        <h2 class="font-display text-3xl tracking-tight sm:text-4xl text-slate-50">Client Feedback & Reviews</h2>
      ...
      <ul role="list"
        ...
        <li v-for="feedbackObj in feedbacks">
            ...
            <li>
              <figure class="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10"><svg aria-hidden="true"
                ...
                <blockquote class="relative">
                  <p class="text-lg tracking-tight text-slate-900 text-center">{{ feedbackObj.feedback }}</p>
                </blockquote>
                <figcaption class="relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6">
                  <div>
                    <div class="font-display text-base text-slate-900">{{ feedbackObj.name }}</div>
                  </div>
                  <div class="overflow-hidden rounded-full bg-slate-50">
                    <img alt="" class="h-14 w-14 object-cover" style="color:transparent" :src="feedbackObj.imgSrc">
                  </div>
                </figcaption>
              </figure>
            </li>
...
const feedbacks = [
  ...
  { name: "Sarah Johnson", location: "Jakarta", feedback: "Allied Analysis Consulting transformed our business strategy. Their expert guidance and data-driven approach led to remarkable growth. We couldn't be happier!" ,
