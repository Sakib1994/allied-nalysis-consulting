...
const mr = Symbol.toStringTag, yi = n((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Qs = n((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Ys = n((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a2 } = await import('./multipart-parser-LQyvp168.mjs');
...
const unhead_QrA5BTKwW2 = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "appointment",
    path: "/appointment",
    component: () => import('./appointment-DIXF6pX3.mjs').then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-CS7yo84n.mjs').then((m) => m.default || m)
  },
  {
    name: "faq",
    path: "/faq",
    component: () => import('./faq-D_nLXuNp.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-D3v9uFa5.mjs').then((m) => m.default || m)
  },
  {
    name: "service",
    path: "/service",
    component: () => import('./service-BYLM74GG.mjs').then((m) => m.default || m)
  }
];
...
const revive_payload_server_OEQT42zHcs = /* @__PURE__ */ defineNuxtPlugin({
...
const plugin_server_0vHTLmxlxT = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  var _a2;
...
const plugins = [
  unhead_QrA5BTKwW2,
  plugin,
  revive_payload_server_OEQT42zHcs,
  components_plugin_KR1HBZs4kY,
  plugin_server_0vHTLmxlxT
];
const layouts = {
  default: () => import('./default-CbL5dKCc.mjs').then((m) => m.default || m)
};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({ class: "layouts" }, _attrs), {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CU1mX1yf.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-qkuwC3tk.mjs').then((r) => r.default || r));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.13.0_@parcel+watcher@2.4.1_@types+node@22.5.0_ioredis@5.4.1_magicast@0.3.4_rollup@4.21_5jo4rrrtxrmre6p7bbzk3kw4mu/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.13.0_@parcel+watcher@2.4.1_@types+node@22.5.0_ioredis@5.4.1_magicast@0.3.4_rollup@4.21_5jo4rrrtxrmre6p7bbzk3kw4mu/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { On as O, _export_sfc as _, useRoute$1 as a, br as b, useRouter as c, navigateTo as d, entry$1 as default, useNuxtApp as e, useRuntimeConfig as f, withoutTrailingSlash as g, hasProtocol as h, joinURL as j, nuxtLinkDefaults as n, parseQuery$1 as p, resolveRouteObject as r, useHead as u, withTrailingSlash as w };
